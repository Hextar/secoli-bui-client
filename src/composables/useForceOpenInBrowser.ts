  ...
  const tryOpenBrowser = (): void => {
    if (document.body) {
      if (isInApp(['FBAN', 'FBAV'])) {
        alert('Hai aperto il sito da un link Facebook. Per ragioni di stabilità, si consiglia di cliccare l\'icona \'...\' in alto a destra e selezionare "Apri nel browser"')
