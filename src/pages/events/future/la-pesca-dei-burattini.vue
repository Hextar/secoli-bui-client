    ...
    <template #content>
      <div id="info" class="anchor pb- flex flex-col items-start justify-center pt-16 pb-0 sm:pb-8">
        <div class="mb-8 flex flex-col" itemprop="name">
          <h1 class="event-title mb-4 flex-inline text-center font-display text-6xl text-white-100" to="/" exact>
            La
          ...
          <h2 class="mb-4 text-center font-display text-2xl uppercase text-white-100 sm:text-left" to="/" exact>
  ...
  <div class="bg-white-100 pb-16">
    ...
    <Article>
      ...
      <Paragraph class="mb-4">
        ...
        <Image class="float-none mx-auto sm:float-left sm:mr-16"
          :src="getAssetPath('i_portatori_della_fiamma_bianca.svg')" :width="160" title="Portatori della Fiamma Bianca"
      ...
      <Paragraph>
        ...
        <Image class="float-none mx-auto sm:float-right sm:ml-16" :src="getAssetPath('le_code_mozzate.svg')"
      ...
      <Paragraph>
        ...
        <Image class="float-none mx-auto sm:float-left sm:mr-16" :src="getAssetPath('l_ineluttabile_domani.svg')"
          :width="160" title="Portatori della Fiamma Bianca" alt="Portatori della Fiamma Bianca" />
        <p class="text-justify">
      ...
      <Paragraph>
        ...
        <Image class="float-none mx-auto sm:float-right sm:ml-16"
          :src="getAssetPath('i_cercatori_del_sentiero_dorato.svg')" :width="160" title="Portatori della Fiamma Bianca"
          alt="Portatori della Fiamma Bianca" />
        <p class="text-justify">
      ...
      <Paragraph>
        ...
        <Image class="float-none mx-auto sm:float-left sm:mr-16" :src="getAssetPath('le_fauci_grondanti.svg')"
          :width="160" title="Portatori della Fiamma Bianca" alt="Portatori della Fiamma Bianca" />
        <p class="text-justify">
      ...
      <Paragraph>
        ...
        <Image class="float-none mx-auto sm:float-right sm:ml-16" :src="getAssetPath('la_loghia_del_gufo.svg')"
          :width="160" title="Portatori della Fiamma Bianca" alt="Portatori della Fiamma Bianca" />
        <p class="text-justify">
