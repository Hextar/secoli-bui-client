...
const ITEMS: FateItem[] = [
  ...
  { label: 'Dalle stelle alle stalle', disabled: true },
  { label: 'Debito di morte', disabled: false },
  { label: 'Eterno Secondo', disabled: false },
  { label: 'Fede che vacilla', disabled: true },
  { label: 'Fortuna sospetta', disabled: true },
  { label: 'Il buio', disabled: true },
  { label: 'Il cinico perduto', disabled: true },
  { label: 'Il Desiderato', disabled: false },
  { label: 'Il giorno', disabled: false },
  { label: 'Il girasole', disabled: false },
  { label: 'Il glicine', disabled: true },
  { label: 'Il mare', disabled: true },
  { label: 'Il prato', disabled: false },
  { label: 'Il risvegliato', disabled: true },
  ...
  { label: 'La bottiglia incendiaria', disabled: true },
